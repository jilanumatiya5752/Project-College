...
if(!isset($error)){ 
  ...
  $y="UPDATE cproject SET projectname='$pname',completed='$completed',createdby='$t'WHERE id='$id'";
  // print_r($y);
  // exit;
...
header("location:project.php?update_profile=1");
   ...
   else 
   {
    ...
    if($rows != 0){ 
	 ...
	 $query = "insert into cproject(projectname,completed,createdby)values('$pname','$completed','$t')";
